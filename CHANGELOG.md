...
- **chore: Coverage**: Fix CI test and lints.

## [0.9.1] - 2026-03-17

### Chores

- **chore: Coverage**: Increase unit test coverage, by adding missing unit tests for commands and report generator.

## [0.9.0] - 2026-03-16

### Added

- **Feature: Report**: Add a menu entry to generate a report of the line counts of all too long or almost too long files in the workspace.
